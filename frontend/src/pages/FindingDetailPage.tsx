...
export function FindingDetailPage() {
  ...
  return (
    <div className="screen-content p-8 max-w-4xl">
      <button
        onClick={() => navigate(-1)}
        className="mb-6 inline-flex items-center gap-2 text-sm transition hover:opacity-70"
      ...
      <div className="glass rounded-2xl p-6 mb-6 relative overflow-hidden">
        ...
        <div className="relative">
          <div className="flex items-center gap-2 mb-3">
            <div
              className={`inline-flex items-center gap-2 px-2.5 py-1 rounded-md ${severityClass} text-xs font-bold`}
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
        <div className="glass rounded-xl p-4">
          ...
          <div className="font-mono text-sm">
            ...
            {finding.lineStart && (
              <span style={{ color: 'var(--text-tertiary)' }}>:{finding.lineStart}</span>
            )}
          </div>
        </div>
        <div className="glass rounded-xl p-4">
      ...
      {finding.detectedCode && (
        <section className="mb-6">
          <div className="flex items-center gap-2 mb-3">
            <div className="w-1 h-5 rounded" style={{ background: '#E11D48' }} />
          ...
          <div className="glass rounded-xl overflow-hidden">
            <pre
              className="code-block p-5 overflow-x-auto"
              style={{ background: 'var(--code-bg)' }}
            >
              <code>{finding.detectedCode}</code>
            </pre>
          </div>
        </section>
      )}
      ...
      <section className="mb-6">
        <div className="flex items-center gap-2 mb-3">
          <div className="w-1 h-5 rounded" style={{ background: 'var(--accent-purple)' }} />
          <h2 className="font-semibold flex items-center gap-2">
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(167,139,250,0.08), rgba(79,139,255,0.08))',
      ...
      {finding.fixSuggestion && (
        <section className="mb-6">
          <div className="flex items-center gap-2 mb-3">
            <div className="w-1 h-5 rounded" style={{ background: '#16A34A' }} />
            <h2 className="font-semibold flex items-center gap-2">
